...
const STATUS_STYLES: Record<IssueStatus, string> = {
  ...
  detected: "bg-amber-100 text-amber-800 dark:bg-amber-900/40 dark:text-amber-200",
  acknowledged: "bg-blue-100 text-blue-800 dark:bg-blue-900/40 dark:text-blue-200",
  ...
  reopened: "bg-orange-100 text-orange-800 dark:bg-orange-900/40 dark:text-orange-200",
};
