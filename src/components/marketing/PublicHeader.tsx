      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-10">
          <Link href={CANONICAL_SITE_URL} className="flex items-center gap-3">
            <Image src="/images/solvren-mark.svg" alt="" width={40} height={40} className="h-10 w-10 shrink-0 object-contain" priority />
            <div>
      ...
      <div className={cn("border-t border-white/10 lg:hidden", open ? "block" : "hidden")}>
        <div className="mx-auto flex max-w-7xl flex-col gap-2 px-4 py-4 sm:px-6">
          ...
          <div className="mt-2 flex items-center gap-2">
            ...
            <Link href="/pilot#pilot-request" className="flex-1">
