...
export async function getPostgresClientForAccount(
  ...
  const creds = revealCredentialTokenFields(credsRow as Record<string, unknown>, systemCredentialReveal(orgId, "postgres_readonly", "provider_api_call", integrationAccountId)) as { access_token?: string };
