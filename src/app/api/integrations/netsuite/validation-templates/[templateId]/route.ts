...
export async function PUT(
  ...
  await admin.from("netsuite_validation_templates").update(updates).eq("id", templateId).eq("org_id", orgId);
  await auditLog(supabase, { orgId, actorId: userRes.user.id, actorType: "USER", action: "netsuite.validation_template.updated", entityType: "netsuite_template", entityId: templateId, metadata: {} });
