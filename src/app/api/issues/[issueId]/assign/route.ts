...
import { assignIssue } from "@/modules/issues";
import { AssignIssueSchema } from "@/modules/issues/api/schemas";
...
export async function POST(
  ...
  const result = await assignIssue(supabase, issueId, auth.userId, parsed.data);
  if (result.error) {
