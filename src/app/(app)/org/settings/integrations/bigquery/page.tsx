/**
 * Phase 3 — BigQuery integration setup.
 */
...
import BigQueryIntegrationCard from "@/components/integrations/BigQueryIntegrationCard";
import { isAdminLikeRole, parseOrgRole } from "@/lib/rbac/roles";
import { getAccountByOrgAndProvider } from "@/modules/integrations/core/integrationAccountsRepo";

export default async function BigQueryIntegrationPage() {
  ...
  const { data: account } = await getAccountByOrgAndProvider(supabase, activeOrgId, "bigquery");
    ...
    <div className="max-w-2xl">
      <Stack gap={6}>
        <PageHeader
          ...
          title="BigQuery"
          description="Sync data from BigQuery for revenue context."
          right={
