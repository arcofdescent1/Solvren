/**
 * Phase 3 — Snowflake integration setup.
 */
...
import SnowflakeIntegrationCard from "@/components/integrations/SnowflakeIntegrationCard";
import { isAdminLikeRole, parseOrgRole } from "@/lib/rbac/roles";
import { getAccountByOrgAndProvider } from "@/modules/integrations/core/integrationAccountsRepo";

export default async function SnowflakeIntegrationPage() {
  ...
  const { data: account } = await getAccountByOrgAndProvider(supabase, activeOrgId, "snowflake");
    ...
    <div className="max-w-2xl">
      <Stack gap={6}>
        <PageHeader
          ...
          title="Snowflake"
          description="Sync data from Snowflake warehouse for revenue context."
          right={
