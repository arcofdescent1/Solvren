/**
 * Phase 3 — MySQL integration setup.
 */
...
import MySQLIntegrationCard from "@/components/integrations/MySQLIntegrationCard";
...
export default async function MySQLIntegrationPage() {
  ...
  const { data: account } = await getAccountByOrgAndProvider(supabase, activeOrgId, "mysql_readonly");
    ...
    <div className="max-w-2xl">
      <Stack gap={6}>
        <PageHeader
          ...
          title="MySQL"
          description="Sync read-only data from MySQL for revenue context."
          right={
