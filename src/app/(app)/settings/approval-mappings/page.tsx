...
import ApprovalMappingsClient from "./ApprovalMappingsClient";
import { isAdminLikeRole, parseOrgRole } from "@/lib/rbac/roles";

export default async function ApprovalMappingsPage() {
  ...
  if (!isAdmin) {
    return (
      <Stack gap={4}>
        <p className="text-sm text-[var(--text)]">Only org owners/admins can manage approval mappings.</p>
